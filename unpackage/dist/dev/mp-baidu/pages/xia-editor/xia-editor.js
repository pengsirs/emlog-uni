...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    z: {
      "updateModelValue": common_vendor.o(($event) => $data.excerpt = $event)
    },
    A: common_vendor.p({
      type: "textarea",
    ...
    H: {
      "updateModelValue": common_vendor.o(($event) => $data.tags = $event)
    },
    I: common_vendor.p({
    ...
    K: {
      "updateModelValue": common_vendor.o(($event) => _ctx.accordionVal = $event),
      "change": common_vendor.o($options.change)
    },
    L: common_vendor.p({
      accordion: true,
      modelValue: _ctx.accordionVal
    }),
    M: common_vendor.o(($event) => $options.fabu())
  };
}
