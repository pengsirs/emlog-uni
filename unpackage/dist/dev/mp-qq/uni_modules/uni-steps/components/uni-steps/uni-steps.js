...
const _sfc_main = {
  ...
  methods: {
    toInfo(e) {
      console.log(this.$emit("toInfo", e));
      this.$emit("toInfo", e);
    }
  }
};
  ...
  return {
    a: common_vendor.f($props.options, (item, index, i0) => {
      return {
        ...
        c: common_vendor.o(($event) => $options.toInfo(item.id)),
        d: common_vendor.t(item.date),
        e: common_vendor.o(($event) => $options.toInfo(item.id)),
        f: index
      };
    }),
...
var Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/pengsong/Downloads/Web/uni-app/demo2/uni_modules/uni-steps/components/uni-steps/uni-steps.vue"]]);
